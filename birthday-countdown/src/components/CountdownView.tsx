...
import { getTargetDate, calculateCountdown, type CountdownTime } from '../utils/countdown';

interface CountdownViewProps {
  onReachTarget: () => void;
}

export const CountdownView: React.FC<CountdownViewProps> = ({ onReachTarget }) => {
    ...
    <div className="countdown-view">
      <div className="countdown-header">
        <h1 className="countdown-title">
          Counting down to your day, Noura 🎉
        </h1>
        <p className="countdown-subtitle">
          Getting ready for August 28.
        </p>
      </div>
